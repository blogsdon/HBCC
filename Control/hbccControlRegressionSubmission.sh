...
provenanceFile="/shared/HBCC/Control/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/HBCC/Control/Regressionerror.txt"

#path to out output
outOutput="/shared/HBCC/Control/Regressionout.txt"

#job script name
jobname="hbccRegressionControl"
