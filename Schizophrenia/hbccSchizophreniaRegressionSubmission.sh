...
provenanceFile="/shared/HBCC/Schizophrenia/provenanceFileRegression.txt"

#path to error output
errorOutput="/shared/HBCC/Schizophrenia/Regressionerror.txt"

#path to out output
outOutput="/shared/HBCC/Schizophrenia/Regressionout.txt"

#job script name
jobname="hbccRegressionSchizophrenia"
