...
provenanceFile="/shared/HBCC/Bipolar/provenanceFileMICor.txt"

#path to error output
errorOutput="/shared/HBCC/Bipolar/MICorerror.txt"

#path to out output
outOutput="/shared/HBCC/Bipolar/MICorout.txt"

#job script name
jobname="hbccMICorBipolar"
